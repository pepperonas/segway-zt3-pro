        ...
        Column(
            ...
            Section(stringResource(R.string.profiles_unlock)) {
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Column(modifier = Modifier.weight(1f)) {
                        Text(
                            stringResource(R.string.profiles_brake_triple_tap),
                            fontWeight = FontWeight.Medium,
                        )
                        Text(
                            stringResource(R.string.profiles_brake_triple_tap_hint),
                            style = MaterialTheme.typography.bodySmall,
                            color = MaterialTheme.colorScheme.onSurfaceVariant
                        )
                    }
                    Switch(
                        checked = settings.brakeTripleTapEnabled,
                        onCheckedChange = vm::setBrakeTripleTap,
                    )
                }
            }
        }
